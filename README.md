# <center> CSE-521-Big-Data-Analytics <center>
  ...
  <center><h2> Course Project on Big Data Analysis with the help of PySpark SQL and MLLib</h2><center><br>
  ...
  ### Project Statement:<br>
     ...
     The data is fairly huge -> 3.5 Gb Tabular Data (Structured) and ~20Gb Image Data (Unstructured). Dealing with this volume of data, it is a good advantage to have the data stored locally for faster access.
...
### How to run the Code:
  ...
  3. <b>PySpark ALS Recommender System
   Model Logging and Tracking with W&B.
